    ...
    <div className="post">
      ...
      <div className="post_body">
        ...
        <div className="post_footer">
          ...
          <img
            width={"30px"}
            src="https://static.vecteezy.com/system/resources/thumbnails/000/284/988/small/a19.jpg"
            alt=""
          />
          <img
            width={"30px"}
            src="https://static.vecteezy.com/system/resources/previews/014/455/886/original/share-icon-on-transparent-background-free-png.png"
            alt=""
          />
          <img
            width={"30px"}
