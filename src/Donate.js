        ...
        <div class="container">
          ...
          <div id="img-1" class="img-container">
            <img
              class="img"
              src={
                "https://assets-global.website-files.com/63804561992fec607543f6d0/644a3675f3756f74bad835e9_Frame-2.png"
              }
            />
          </div>
    ...
    <img class="img" src={"https://wallpapershome.com/images/pages/pic_v/13886.jpg"}/>
          ...
          <div class="img-container third-animation">
            <img
              class="img"
              src={
                "https://assets-global.website-files.com/63804561992fec607543f6d0/63d9cee2f1e5b9cc7415c707_Ganga%20color%20(home%20page).png"
              }
            />
          </div>
          ...
          <div class="img-container fourth-animation">
            <img
              class="img nba"
              src={
                "https://assets-global.website-files.com/63804561992fec607543f6d0/63eba6f7c2eaacf52c8fd46f_Frame.png"
              }
            />
          </div>
          ...
          <div class="img-container fifth-animation">
            <img
              class="img"
              src={
                "https://assets-global.website-files.com/63804561992fec607543f6d0/644a3674bcbc64e39d8707d9_Frame.png"
              }
            />
          </div>
    ...
    <img class="img" src={"http://orig15.deviantart.net/3c71/f/2016/121/9/4/reaper_wallpaper__overwatch__by_prollgurke-da0wf9m.png"}/>
          ...
          <div id="img-7" class="img-container seventh-animation">
            <img
              class="img"
              src={
                "https://assets-global.website-files.com/63804561992fec607543f6d0/63d9cee0d4e24a161bef06ae_Sudha%20color%20(home%20page).png"
              }
            />
          </div>
        </div>
        ...
        <div className="outer-wrapper">
          ...
          <div class="inner-wrapper-hero sad">
            <div class="payemnt-wrapper">
              <div
                data-w-id="2d335d07-5ffe-574b-2c97-328d886917e2"
                class="text-block-2"
              >
              ...
              <div class="div-block-6">
                <div
                  data-w-id="2d335d07-5ffe-574b-2c97-328d886917e5"
                  class="div-block-4 amounts"
                  style={{
                    opacity: 1,
                    transform:
                ...
                <div
                  data-w-id="2d335d07-5ffe-574b-2c97-328d886917e7"
                  class="div-block-4 amounts"
                  style={{
                    opacity: 1,
                    transform:
                ...
                <div
                  data-w-id="2d335d07-5ffe-574b-2c97-328d886917e9"
                  class="div-block-4 amounts"
                  style={{
                    opacity: 1,
                    transform:
              ...
              <div class="div-block-6">
                <div
                  data-w-id="2d335d07-5ffe-574b-2c97-328d886917ec"
                  class="div-block-4 amounts"
                  style={{
                    opacity: 1,
                    transform:
                ...
                <div
                  data-w-id="2d335d07-5ffe-574b-2c97-328d886917ee"
                  class="div-block-4 amounts other"
                  style={{
                    opacity: 1,
                    transform:
                      "translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)",
              ...
              <div class="div-block-6">
                <div
                  ...
                  data-w-id="2d335d07-5ffe-574b-2c97-328d886917f1"
                  class="div-block-4 amounts other button saf"
                  style={{
                    opacity: 1,
                    transform:
                      "translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)",
          ...
          <div style={{ display: "flex", gap: "0.5rem" }}>
            {" "}
            <p style={{ fontWeight: "600" }}>Secured By</p>
            <img
              width={"100px"}
          ...
          <div class="cards">
              ...
              <div class="inner">
                ...
                <ul class="features">
                  ...
                  <li class="li">
                    ...
                    <span>
                      <strong>Make independent </strong>
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <article class="plan [ card ]">
              <div class="inner">
                ...
                <p class="info">
                  Financial barriers can often hinder individuals with
                  disabilities{" "}
                </p>
                <ul class="features">
                  <li class="li">
                    ...
                    <span>
                      <strong>Empower Through Education</strong>
                    </span>
                  </li>
                  <li class="li">
                    <span class="icon">
                    ...
                    <span>
                      <strong>Enable Skills Acquisition</strong>
                    </span>
                  </li>
                  <li class="li">
                    <span class="icon">
