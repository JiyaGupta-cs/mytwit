        ...
        <div class="r-cards">
          <article class="plan [ r-card ]">
            <div class="r-inner">
              ...
              <a
                ...
                target="_blank"
              >
                <button class="dn_button">Click to View</button>{" "}
              </a>
            </div>
          </article>
          <article class="plan [ r-card ]">
          ...
          <article class="plan [ r-card ]">
            <div class="r-inner  bg-white">
              ...
              {/* <p class="info">The Disabilities Act ensures equal rights for individuals with disabilities in education and employment.</p> */}
              <a
                href="https://drive.google.com/drive/folders/1DKdPhbxjknH0crjfhgwSasOCCxZ0b3Dg"
                target="_blank"
              >
                <button class="dn_button">Click to View</button>{" "}
              </a>
          ...
          <article class="plan [ r-card ]">
            <div class="r-inner">
              ...
              {/* <p class="info">The Disabilities Act ensures equal rights for individuals with disabilities in education and employment.</p> */}
              <a
                href="https://drive.google.com/file/d/13kt4xe-R1S0N-Uf0r8IzdChKnBYLk3BX/view"
                target="_blank"
              >
                <button class="dn_button">Click to View</button>{" "}
              </a>
